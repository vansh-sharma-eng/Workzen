...
const TABS = ["All", "To Do", "In Progress", "Completed", "Failed"];

const TaskHeader = ({ view, setView, statusFilter, setStatusFilter, onCreateTask }) => {
  return (
    <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1 bg-white text-black px-3 py-1.5 rounded-md font-semibold hover:bg-gray-200 transition-all"
        >
          <Plus size={22} />
          Create Task
        </button>
