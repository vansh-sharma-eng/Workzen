...
const TaskColumn = ({ title, color, tasks, onAdd, onStatusChange }) => {
  return (
    <div className="bg-[#14151c] border border-[#272727] rounded-xl p-5 h-fit">
        ...
        <button
          onClick={onAdd}
          className="w-7 h-7 rounded-lg bg-[#1d2028] border border-[#272727] flex items-center justify-center hover:border-gray-500 transition"
        >
